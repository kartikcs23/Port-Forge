    ...
    <div className="min-h-screen bg-background flex flex-col selection:bg-accent selection:text-white border-t-0">
      ...
      <div className="flex-1 flex flex-col items-center justify-center py-12 px-4 sm:px-6 lg:px-8 relative overflow-hidden">
        ...
        <div className="text-center mb-8 relative z-10">
          <h2 className="text-5xl font-black text-ink uppercase tracking-tighter mb-2">INITIALIZE</h2>
          <p className="text-muted font-sans font-bold uppercase tracking-widest text-sm">CREATE NEW INSTANCE</p>
        </div>

        <div className="relative z-10 shadow-brutal border-2 border-ink p-1 bg-surface">
          <SignUp 
            routing="path" 
            path="/register" 
            signInUrl="/login" 
